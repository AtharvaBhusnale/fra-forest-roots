...
-- Add updated_at column to admin_actions and create trigger
ALTER TABLE public.admin_actions ADD COLUMN updated_at timestamp with time zone NOT NULL DEFAULT now();
